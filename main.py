...
if __name__ == '__main__':
    ...
    ax = visualizer.prepare_graph("Skeleton tessellation")
    visualizer.plot_skeleton(global_point_bank, ax)
    visualizer.plot_decision_boundary(boundary_extractor, classification_polygons, lines_used, ax, vis_data)
    visualizer.draw_loss_landscape()   # set class_index=1 for blue class
    visualizer.draw_decision_landscape(skeleton=False, decision=False, heatmap=True)
    print('Done!')
