...
if __name__ == '__main__':
    ...
    plt.errorbar(np.arange(number_of_epochs, 2*number_of_epochs + small_epochs, small_epochs),
    ...
    plt.errorbar(np.arange(0, number_of_epochs + small_epochs, small_epochs),
